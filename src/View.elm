...
buttonSvg click selected children =
    svg
...
view model =
    ...
    div
        ...
        , div
            ...
            (buttonSvg ToggleMic micEnabled []
                :: (OscilatorType.all
                        |> Dict.toList
                        |> List.map
                            (\( name, t ) ->
                                buttonSvg (SetOscilatorType t) (name == OscilatorType.toString model.oscilatorType) [ oscilatorIcon t ]
                            )
                   )
            )
        ]
