...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Worker.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var $author$project$Worker$Model = {};
...
var $author$project$Worker$init = function (_v0) {
	return _Utils_Tuple2($author$project$Worker$Model, $elm$core$Platform$Cmd$none);
};
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$Worker$Data = function (a) {
	return {$: 'Data', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Worker$data = _Platform_incomingPort('data', $elm$json$Json$Decode$value);
var $author$project$Worker$subscriptions = function (_v0) {
	return $author$project$Worker$data($author$project$Worker$Data);
};
...
var $author$project$Waveform$autoCorrelate = function (samples) {
	var correlate = F2(
		function (acc, shiftedSamples) {
			correlate:
			while (true) {
				if (!shiftedSamples.b) {
					return $elm$core$List$reverse(acc);
				} else {
					var rest = shiftedSamples.b;
					var $temp$acc = A2(
						$elm$core$List$cons,
						A3(
							$elm$core$List$foldl,
							$elm$core$Basics$add,
							0,
							A3($elm$core$List$map2, $elm$core$Basics$mul, samples, shiftedSamples)),
						acc),
						$temp$shiftedSamples = rest;
					acc = $temp$acc;
					shiftedSamples = $temp$shiftedSamples;
					continue correlate;
				}
			}
		});
	return A2(correlate, _List_Nil, samples);
};
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Waveform$averageDistance = function (peakIndexes) {
	var spacing = function (list) {
		if (list.b && list.b.b) {
			var first = list.a;
			var _v1 = list.b;
			var second = _v1.a;
	...
	var distances = spacing(peakIndexes);
	return $elm$core$List$sum(distances) / $elm$core$List$length(distances);
};
...
var $author$project$Waveform$detectPeaks = function (samples) {
	var detectPeaks_ = F3(
		function (i, memo, samples_) {
			detectPeaks_:
			while (true) {
				var peaks = memo.peaks;
				var skip = memo.skip;
				var threshold = memo.threshold;
				var detect = F2(
					function (first, second) {
						return ((second - first) >= 0) ? _Utils_update(
							memo,
							{skip: false}) : ((skip || (_Utils_cmp(first, threshold) < 0)) ? memo : _Utils_update(
							memo,
							{
								peaks: _Utils_ap(
									peaks,
									_List_fromArray(
										[
											_Utils_Tuple2(i, first)
										])),
								skip: true,
								threshold: 0.5 * first
							}));
					});
				if (samples_.b && samples_.b.b) {
					var first = samples_.a;
					var _v1 = samples_.b;
					var second = _v1.a;
					var rest = _v1.b;
					var $temp$i = i + 1,
						$temp$memo = A2(detect, first, second),
						$temp$samples_ = A2($elm$core$List$cons, second, rest);
					i = $temp$i;
					memo = $temp$memo;
					samples_ = $temp$samples_;
					continue detectPeaks_;
				} else {
					return peaks;
				}
			}
	...
	return A3(
		detectPeaks_,
		0,
		{peaks: _List_Nil, skip: false, threshold: 0},
		samples);
};
...
var $author$project$Waveform$samplesPerRepetition = A2(
	$elm$core$Basics$composeR,
	$author$project$Waveform$autoCorrelate,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Waveform$detectPeaks,
		A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map($elm$core$Tuple$first),
			$author$project$Waveform$averageDistance)));
var $author$project$Worker$detectFrequencies = function (dict) {
	return A2(
		$elm$core$Dict$map,
		F2(
			function (_v0, waveform) {
				return $author$project$Waveform$samplesPerRepetition(waveform);
			}),
		dict);
};
...
var $author$project$Worker$encodeFrequencies = function (waveforms) {
	return A2(
		...
		$elm$core$Dict$toList(waveforms));
};
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $author$project$Worker$results = _Platform_outgoingPort('results', $elm$core$Basics$identity);
...
var $author$project$Worker$update = F2(
	function (message, _v0) {
		var payload = message.a;
		return _Utils_Tuple2(
			$author$project$Worker$Model,
			$author$project$Worker$results(
				$author$project$Worker$encodeFrequencies(
					$author$project$Worker$detectFrequencies(
						A2(
...
_Platform_export({'Worker':{'init':$author$project$Worker$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Worker.Action","aliases":{},"unions":{"Worker.Action":{"args":[],"tags":{"Data":["Json.Encode.Value"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});
...
var _Worker = require("./Worker.elm");

global.document = {}; // to trick parcel

var worker = _Worker.Elm.Worker.init();
...
worker.ports.results.subscribe(function (data) {
  postMessage(data);
});
},{"./Worker.elm":"Worker.elm"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
