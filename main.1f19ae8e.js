...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{
			notes: elm$core$Dict$empty,
			oscilatorType: author$project$OscilatorType$Sine,
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$Main$waveforms(author$project$Model$Waveform),
				author$project$Main$notePressed(author$project$Model$NotePressed)
			]));
};
var author$project$Main$getWaveforms = _Platform_outgoingPort('getWaveforms', elm$core$Basics$identity);
var elm$json$Json$Encode$int = _Json_wrap;
var author$project$Main$buildGetWaveformsCommand = function (notes) {
	var _n0 = elm$core$Dict$values(notes);
	if (!_n0.b) {
		return elm$core$Platform$Cmd$none;
	} else {
		var values = _n0;
		return author$project$Main$getWaveforms(
			A2(
				elm$json$Json$Encode$list,
				function (note) {
					return elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'id',
								elm$json$Json$Encode$int(note.id)),
								_Utils_Tuple2('node', note.node)
							]));
				},
				values));
	}
...
var author$project$Main$interval = function (n) {
	return A2(elm$core$Basics$pow, 2, n / 12.0);
};
...
var author$project$Main$buildNoteCommand = F2(
	function (n, ot) {
		var oscilatorType = author$project$OscilatorType$toString(ot);
		var freq = 220 * author$project$Main$interval(n + 3);
		var json = elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
		...
		return author$project$Main$notePress(json);
	});
var author$project$Main$noteRelease = _Platform_outgoingPort('noteRelease', elm$core$Basics$identity);
var author$project$Main$buildReleaseCommand = function (note) {
	return author$project$Main$noteRelease(
		elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'attack',
					elm$json$Json$Encode$float(note.attack)),
					_Utils_Tuple2('node', note.node)
				])));
};
var author$project$Model$Note = F6(
	function (id, frequency, attack, node, waveform, oscilatorType) {
		return {attack: attack, frequency: frequency, id: id, node: node, oscilatorType: oscilatorType, waveform: waveform};
	});
var elm$json$Json$Decode$float = _Json_decodeFloat;
var elm$json$Json$Decode$map6 = _Json_map6;
var author$project$Main$decodeNote = function (note) {
	var decoder = A7(
		elm$json$Json$Decode$map6,
		author$project$Model$Note,
		A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
		A2(elm$json$Json$Decode$field, 'frequency', elm$json$Json$Decode$float),
		A2(elm$json$Json$Decode$field, 'attack', elm$json$Json$Decode$float),
		A2(elm$json$Json$Decode$field, 'node', elm$json$Json$Decode$value),
		elm$json$Json$Decode$succeed(_List_Nil),
		elm$json$Json$Decode$succeed(author$project$OscilatorType$Sine));
	return A2(elm$json$Json$Decode$decodeValue, decoder, note);
};
var author$project$Main$WaveformMessage = F2(
	function (id, waveform) {
		return {id: id, waveform: waveform};
	});
var author$project$Model$dropWhileFirstTwo = F2(
	function (test, list) {
		dropWhileFirstTwo:
		while (true) {
			if (list.b) {
...
var author$project$Model$dropToLocalMinimum = function (values) {
	return A2(
		author$project$Model$dropWhileFirstTwo,
		F2(
			function (a, b) {
				return (a > 0) && (b > 0);
			}),
...
var author$project$Main$decodeWaveforms = F2(
	function (forms, model) {
		...
		var trim = function (wf) {
			return A2(
				elm$core$List$take,
				elm$core$Basics$round(model.scene.height),
				author$project$Model$dropToLocalMinimum(wf));
		};
		var decoder = elm$json$Json$Decode$list(
			A3(
				elm$json$Json$Decode$map2,
				author$project$Main$WaveformMessage,
				A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
				A2(
					elm$json$Json$Decode$field,
					'waveform',
					elm$json$Json$Decode$list(elm$json$Json$Decode$float))));
		var decodedWaveform = A2(elm$json$Json$Decode$decodeValue, decoder, forms);
		if (decodedWaveform.$ === 'Ok') {
			var wfs = decodedWaveform.a;
			return _Utils_update(
				model,
				{
					notes: A3(
...
var author$project$Main$update = F2(
	function (action, model) {
		switch (action.$) {
			case 'ToggleKey':
				var i = action.a;
				var _n1 = A2(elm$core$Dict$get, i, model.notes);
				if (_n1.$ === 'Just') {
					var note = _n1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								notes: A2(elm$core$Dict$remove, i, model.notes)
							}),
						author$project$Main$buildReleaseCommand(note));
				} else {
					return _Utils_Tuple2(
						model,
						A2(author$project$Main$buildNoteCommand, i, model.oscilatorType));
				}
			...
			case 'Waveform':
				var forms = action.a;
				return _Utils_Tuple2(
					A2(author$project$Main$decodeWaveforms, forms, model),
					author$project$Main$buildGetWaveformsCommand(model.notes));
			case 'NotePressed':
				var note = action.a;
				var _n2 = author$project$Main$decodeNote(note);
				if (_n2.$ === 'Ok') {
					var o = _n2.a;
					var notes = A3(elm$core$Dict$insert, o.id, o, model.notes);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{notes: notes}),
						author$project$Main$buildGetWaveformsCommand(notes));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'Viewport':
					...
					function () {
						if (viewPortAction.$ === 'ViewportSet') {
							...
							return _Utils_update(
								model,
								{
									scene: {height: viewPort.height, width: viewPort.width}
								});
						}
					}(),
					elm$core$Platform$Cmd$none);
						...
						switch (zoom.$) {
							...
							case 'ZoomChange':
								...
								if (_n5.$ === 'Nothing') {
									...
									return _Utils_update(
										model,
										{zoom: (point.x - start.x) / model.scene.width});
								}
							default:
								return _Utils_update(
									model,
...
var author$project$View$colors = _List_fromArray(
...
var author$project$View$keyboard = function (notes) {
...
var author$project$View$noteWave = F4(
	function (color, zoom, svgWidth, note) {
		var xDelta = (2 * zoom) / svgWidth;
		var values = note.waveform;
		var lines = A2(
			elm$core$List$indexedMap,
			F2(
				function (i, v) {
					return author$project$PathDefinition$L(
						{x: i * xDelta, y: v * 0.9});
				}),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					author$project$PathDefinition$toString(
						A2(
							elm$core$List$cons,
...
var author$project$View$view = function (model) {
	var svgWidth = model.scene.height;
	var noteIds = elm$core$Set$fromList(
		elm$core$Dict$keys(model.notes));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				elm$html$Html$Attributes$style,
				'height',
				elm$core$String$fromFloat(model.scene.height)),
				A2(elm$html$Html$Attributes$style, 'margin', '20px')
			]),
		_List_fromArray(
			[
				author$project$View$keyboard(noteIds),
				A2(
				elm$html$Html$div,
				_Utils_ap(
					_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$core$String$fromFloat(model.scene.height - 40)),
								...
								A2(elm$html$Html$Attributes$style, 'stroke-width', '0.03')
							]),
						A2(
							elm$core$List$indexedMap,
							F2(
								function (noteId, color) {
									var _n0 = A2(elm$core$Dict$get, noteId, model.notes);
									if (_n0.$ === 'Just') {
										var note = _n0.a;
										return A4(author$project$View$noteWave, color, model.zoom * 10, svgWidth, note);
									} else {
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A2(elm$html$Html$Attributes$style, 'stroke', 'rgb(105, 55, 216)'),
									A2(elm$html$Html$Attributes$style, 'stroke-opacity', '0.5'),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Model.Action","aliases":{"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Model.Point":{"args":[],"type":"{ x : Basics.Float, y : Basics.Float }"},"Model.WidthHeight":{"args":[],"type":"{ width : Basics.Int, height : Basics.Int }"},"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Model.Action":{"args":[],"tags":{"ToggleKey":["Basics.Int"],"Zoom":["Model.ZoomAction"],"Viewport":["Model.ViewportAction"],"Waveform":["Json.Encode.Value"],"NotePressed":["Json.Decode.Value"],"SetOscilatorType":["OscilatorType.OscilatorType"],"AnimationFrame":["Basics.Float"]}},"Model.ViewportAction":{"args":[],"tags":{"ViewportChange":["Model.WidthHeight"],"ViewportSet":["Browser.Dom.Viewport"]}},"Model.ZoomAction":{"args":[],"tags":{"ZoomStop":[],"ZoomStart":["Model.Point"],"ZoomChange":["Model.Point"]}},"OscilatorType.OscilatorType":{"args":[],"tags":{"Sine":[],"Square":[],"Sawtooth":[],"Triangle":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});
...
function getWaveforms(notes) {
  requestAnimationFrame(function () {
    var waveforms = notes.map(function (_ref3) {
      var id = _ref3.id,
          analyser = _ref3.node.analyser;
